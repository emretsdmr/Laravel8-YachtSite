...
class ImageController extends Controller
{
    ...
    public function create($yacht_id)
    {
        ...
        $images=DB::table('images')->where('yacht_id','=',$yacht_id)->get();
    ...
    public function store(Request $request,$yacht_id)
    {
        ...
        $data->save();
        return redirect()->route('admin_image_add',['yacht_id'=>$yacht_id]);
    }
     ...
     * @return \Illuminate\Http\Response
     */
    public function destroy(Image $image,$id,$yacht_id)
    {
        $data=Image::find($id);
        $data->delete();
        return redirect()->route('admin_image_add',['yacht_id'=>$yacht_id]);
