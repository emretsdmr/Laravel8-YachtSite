    ...
    <div class="row clearfix">
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            <div class="card">
                ...
                <div class="body">
                    <form role="form" action="{{route('admin_image_store',['yacht_id'=>$data->id])}}" method="post" enctype="multipart/form-data">
                        @csrf
                        <label>Title</label>
                        ...
                        <table class="table table-bordered">
                            ...
                            @foreach($images as $rs)
                                <tr>
                                    ...
                                    <td><a href="{{route('admin_image_delete',['id'=>$rs->id,'yacht_id'=>$data->id])}}" onclick="return confirm('Delete ! Are you sure?')"><i class="material-icons">delete</i></a></td>
                                </tr>
                            @endforeach
                            </tbody>
                        </table>
