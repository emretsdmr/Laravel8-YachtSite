    ...
    <div class="row clearfix">
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            <div class="card">
                ...
                <div class="body">
                    <form role="form" action="{{route('admin_yacht_update',['id'=>$data->id])}}" method="post" enctype="multipart/form-data">
                        @csrf
                        <label>Title</label>
                        ...
                        <div class="form-group">
                            <div class="form-line">
                                <input type="text" name="lengthoverall" value="{{$data->lengthoverall}}" class="form-control" >
                            </div>
                        </div>
                        <label>Engine(s)</label>
                        <div class="form-group">
                            <div class="form-line">
                                <input type="text" name="engine" value="{{$data->engine}}" class="form-control" >
                            </div>
                        </div>
                        <label>Year Built</label>
                        <div class="form-group">
                            <div class="form-line">
                                <input type="text" name="yearbuilt" value="{{$data->yearbuilt}}" class="form-control" >
                            </div>
                        </div>
                        <label>Speed</label>
                        <div class="form-group">
                            <div class="form-line">
                                <input type="text" name="speed" value="{{$data->speed}}" class="form-control" >
                            </div>
                        </div>
                        <label>Hull</label>
                        <div class="form-group">
                            <div class="form-line">
                                <input type="text" name="hull" value="{{$data->hull}}" class="form-control" >
                            </div>
                        </div>
                        <label>Beam</label>
                        <div class="form-group">
                            <div class="form-line">
                                <input type="text" name="beam" value="{{$data->beam}}" class="form-control" >
                            </div>
                        </div>
                        <label>Sails</label>
                        <div class="form-group">
                            <div class="form-line">
                                <input type="text" name="sails" value="{{$data->sails}}" class="form-control" >
                            </div>
                        </div>
                        <label>Cabins</label>
                        <div class="form-group">
                            <div class="form-line">
                                <input type="text" name="cabins" value="{{$data->cabins}}" class="form-control" >
                            </div>
                        </div>
                        <label>Fuel Capacity</label>
                        <div class="form-group">
                            <div class="form-line">
                                <input type="text" name="fuelcapacity" value="{{$data->fuelcapacity}}" class="form-control" >
                            </div>
                        </div>
                        <label>Draft</label>
                        <div class="form-group">
                            <div class="form-line">
                                <input type="text" name="draft" value="{{$data->draft}}" class="form-control" >
                            </div>
                        </div>
                        <label>Generator</label>
                        <div class="form-group">
                            <div class="form-line">
                                <input type="text" name="generator" value="{{$data->generator}}" class="form-control" >
                            </div>
                        </div>
                        <label>Crew</label>
                        <div class="form-group">
                    ...
                    <button type="submit" class="btn btn-primary m-t-15 waves-effect">Edit Yacht</button>
                    </form>
                </div>
            </div>
        </div>
